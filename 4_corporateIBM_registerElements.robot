...
Stop Browser
  ...
  Close All Browsers
*** Test Cases ***
corporateIBM_registerElements
	Go To  ${BASE_URL}/corporate/ibm/register
	...
	Page Should Contain Element  css=div#corporate-banner > img[src*='ibm.png']
	Page Should Contain Element  css=h1.page-title  Join CareGeneral
	...
	#undefined  undefined  undefined
	Input Text  css=#user_name  ibmTest
	Input Text  css=#user_email  ibm@example.ibm.com
	...
	#undefined  undefined  undefined
	Input Text  css=#user_name  ibmTest
	Input Text  css=#user_email  ibm@example.com
	Input Text  css=#user_password  123
	Input Text  css=#user_password_confirmation  123
	#verifyNotAttribute  css=.common-btn@disabled  disabled
	Click Element  css=button.common-btn
	#waitForText  css=div.alert.alert-error  Please signup with your IBM email address. Your email should end with .ibm.com. After you have signed up then you can change your email address to anything you want.
	Page Should Contain Element  css=div.alert.alert-error  Please signup with your IBM email address. Your email should end with .ibm.com. After you have signed up then you can change your email address to anything you want.
	#undefined  undefined  undefined
	Input Text  css=#user_name  ibmTest
	Input Text  css=#user_email  ibmOne@example.ibm.com
	Input Text  css=#user_password  123
	Input Text  css=#user_password_confirmation  123
	#verifyNotAttribute  css=.common-btn@disabled  disabled
	Click Element  css=button.common-btn
