...
Stop Browser
  ...
  Close All Browsers
*** Test Cases ***
individual_register_elements
	Go To  ${BASE_URL}/individuals/register
	Select Window  null
	Page Should Contain Element  css=h1.page-title  Join CareGeneral
	Select Window  null
	Page Should Contain Element  css=h3.greetings-top  Joining CareGeneral is Fast and Easy
	Page Should Contain Element  css=h3.greetings-bottom  Just enter your name, email address and a password!
	...
	Page Should Contain Element  css=button.common-btn  Sign Up
